    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.token) {
          ...
          console.log('[Admin Login] Token stored in localStorage');
        }
        ...
        console.log('[Admin Login] Login failed:', data.message);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-primary p-4">
      ...
      <Card className="w-full max-w-md bg-card text-card-foreground shadow-2xl">
        <CardHeader className="space-y-4 text-center p-6 sm:p-8">
          ...
          <CardTitle className="text-2xl sm:text-3xl font-bold text-primary">بوابة الموارد البشرية - الإدارة</CardTitle>
          <p className="text-sm text-muted-foreground">تسجيل دخول المدراء والإداريين</p>
        </CardHeader>
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="mt-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              موظف؟{' '}
              <a href="/employee/login" className="text-primary hover:underline">
                سجل دخول كموظف
              </a>
            </p>
          </div>
